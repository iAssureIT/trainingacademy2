...
const empJobRoutes=require("./api/admin2.0/jobManagement/empRoutes.js")
...
app.use("/api/emp-job-apply",empJobRoutes)
app.use("/api/lead-genration-routes",landingPageRoutes)
