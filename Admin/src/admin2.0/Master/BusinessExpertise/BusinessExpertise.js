...
class BusinessExpertise extends Component {
    constructor(props) {
        super(props);
        this.state = {
            oneFields : {
            ...
            "fields" : {
                placeholder          : "Add Comma Separated Expertises",
                title                : "Business Expertise",
                secondtitle          : "Business Category",
                attributeName        : "businessExpertise",
                secondAttributeId    : "_id",
            ...
            "tableObjects": {
                deleteMethod    : 'delete',
                apiLink         : '/api/business-expertise/',
                ...
                <section className="col-lg-12 col-md-12 col-xs-12 col-sm-12 companyDisplayForm">
                    <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 pageContent ">
                       <TwoFieldForm   fields={this.state.fields}
                                        ...
                                        onefieldfileurl="https://qaeadvisor.s3.ap-south-1.amazonaws.com/prod/master/xyz.xlsx"
                                        ...
                                        twofieldfileurl="https://qaadvisor.s3.ap-south-1.amazonaws.com/prod/master/abc.xlsx"
