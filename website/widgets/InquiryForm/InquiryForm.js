...
export default class InquiryForm extends React.Component {
  ...
  Submit(event) {
    ...
    if (this.validateForm()) {
      ...
      const formValues2 = {
        toEmail: adminEmail,
        subject: "Inquiry message from Contact Us page on Website",
        text: this.state.message,
        mail:
          "Dear Admin, <br/>" +
        ...
        >
          ...
          <form>
            <div className="text-center">
              <h2 className="text-xl lg:text-2xl xl:3xl font-bold mb-3 mt-10 md:mt-5">
            ...
            <div className={"col-lg-12 col-md-12 col-sm-12 col-xs-12 formRow "}>
              {this.state.btnLoading ? (
                ...
                <button
                  type="button"
                  className="w-full py-3 px-4 submitBtn inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-bold bg-purple text-white hover:border-white hover:text-white  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm xxl:text-xl sm:p-4"
