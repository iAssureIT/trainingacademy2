...
const EmpAppForm = (props) => {
                    ...
                    .then((data) => {
                        ...
                        const formValues1 = {
                            ...
                            mail:
                                ...
                                fields.email +
                                "<br/><br/>" +
                                "Thank you for submitting your application for the role of If your resume meets the shortlisting criteria, our HR team will reach out to you. <br/> <br/> " +
    ...
    return (
        <div id={"empModal"} tabIndex="-1" aria-hidden="true" className="my-10 block overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div className="relative p-4 w-full max-w-md md:max-w-xl  max-h-full mx-auto my-auto">

                <div className="relative bg-white rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] dark:bg-gray-700">

                    <div className="flex items-center justify-between p-4 md:py-3 md:px-4 border-b rounded-t dark:border-gray-600">
                    ...
                    <form id="jobForm" className="my-6 px-10 md:px-5 ">
                        ...
                        <div className="grid md:grid-cols-2  md:gap-x-5">
                            ...
                            <div className="my-2">
                                <label htmlFor="phone" className="label2 ">
                                    Phone<span className="text-red-600 asterik">*</span>
                                </label>
                                <div className="px-0">
                                    <input
                                        type="text"
                        ...
                        <div className="my-2">
                            <label htmlFor="File" className="label2 ">
                                Upload Resume <span className="text-red-600 asterik">*</span>
                            </label>
                            <div className="px-0">
                                <input
                                    type="file"
