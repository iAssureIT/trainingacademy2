                    ...
                    <div data-carousel="slide" ref={slidesContainerRef} className={props?.inputData?.CarouselCss ? props?.inputData?.CarouselCss :
...

                        {
                            ...
                            caseStudyList?.data?.map((data, index) => (
                                <div key={index} className='flex-none  w-auto  sm:w-1/2 lg:w-1/3 xl:w-1/3 h-auto object-cover  text-left   gap-10  slide5 rounded-lg cursor-pointer my-2'>
                                    {/* // <div key={index} className='flex-none   w-auto  sm:w-1/2 lg:w-1/3 xl:w-1/3 h-full object-cover  text-left   gap-10  slide5 rounded-lg cursor-pointer  mb-2 md:mb-10'> */}
                                    <a
                                        className={"text-sm"}
                                    ...
                                    <div className='mx-auto text-darkGray  font-semibold text-xl md:text-sm xl:text-xl text-center py-4'>{data?.projectName}</div>
                                </div>
                            ))
