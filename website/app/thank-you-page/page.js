    ...
    return (
        <main className=" bg-white font-TerminaTest h-full z-4">
            <div className="h-auto pt-10 md:py-20 lg:py-28">
                <div className="bg-white my-4 mx-3 p-6 md:w-3/4 lg:w-1/2 xl:w-2/4 2xl:w-1/3 md:mx-auto border shadow-[0_3px_10px_rgb(0,0,0,0.2)] " >
                    ...
                    <div className="text-center -mt-8">
                        ...
                        <div className="py-10 text-center">
                            ...
                            <a href={process.env.WHATSUP_GROUP_NAME} className="px-12 bg-green-500 hover:bg-indigo-500 text-white font-bold py-3">
