...
import { LeadGenrationForm } from "@/components/Modal/LeadGenForm";
    ...
    subMenu: [
      {
        ...
        img: "/images/specific/MenuImages/iAssureIT-menu-icons/iAssureIT-menu-icon-1.webp",
      ...
      },
      {
        ...
        img: "/images/specific/MenuImages/iAssureIT-menu-icons/iAssureIT-menu-icon-4.webp",
      ...
      },
      {
        ...
        img: "/images/specific/MenuImages/iAssureIT-menu-icons/iAssureIT-menu-icon-6.webp",
      ...
      },
      {
        ...
        img: "/images/specific/MenuImages/iAssureIT-menu-icons/iAssureIT-menu-icon-8.webp",
        bigImg:
      ...
      },
      {
        ...
        img: "/images/specific/MenuImages/iAssureIT-menu-icons/iAssureIT-menu-icon-10.webp",
      ...
      },
      {
        ...
        img: "/images/specific/MenuImages/iAssureIT-menu-icons/iAssureIT-menu-icon-12.webp",
...
const content_Menubar = {
  ...
  navCss:
    "mx-10 lg:mx-10 xl:mx-10 2xl:mx-24 flex flex-wrap items-center justify-between  py-0 ",
...
const content_Footer = {
  ...
  titleCss: "mb-6 text-xl xxl:text-xl font-extrabold  underline  text-white",
  title1: "Menu",
  title2: " Services",
  // title3: " ",
  title4: "Our Awards",
  ...
  classForAwards:
    "relative text-white font-bold bg-cover text-center h-28 md:h-32 py-5 px-10 lg:px-20 xl:px-24 2xl:px-24 text-xs md:text-sm block bg-no-repeat  max-w-full xl:w-3/5 2xl:w-1/4  sm:bg-cover bg-center mb-5",
  awardData: [
    "TOP 50 BRAND FUTURE",
...
const content_Footer2 = {
  ...
  copyrightText:
    '<span class="text-white font-normal">Copyright © <script>document.write(new Date().getFullYear())</script>, <span class="text-white hover:text-ftLink "><a href="https://iassureit.com/"  target="_blank" >iAssureIT</a></span> All Rights Reserved</span>',
    PrivacyPageURL:"/privacy-policy",
    footerText:
    '<span class="text-white mr-1 mb-3">Designed & Developed By</span> <span class="text-light font-bold left hover:text-ftLink "> <a href="/" target="_blank"> iAssure International Technologies Pvt. Ltd.</a></span>',
};
  ...
  return (
    ...
    <html lang="en" suppressHydrationWarning={true}>
      ...
      <body className={" bg-white"}>
        ...
        {/*<button
          className="fixed z-10 top-32 right-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          type="button"
          onClick={openDrawer}
         >
            Get a Quote
