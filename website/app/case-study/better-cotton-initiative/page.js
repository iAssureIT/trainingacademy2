...
const BetterCottonInitiative = (props, data) => {
  ...
  const content_bciBanner = {
    id: "Banner1",
    bgImage: pageData?.bannerImage ? `${process.env.NEXT_PUBLIC_BASE_URL}/${pageData?.bannerImage}` : "",

    smallBGImage: "/images/specific/BCI/smallbanner.webp",
    logo: "",
    ...
    image: "/images/specific/BCI/1.webp",
  ...
  const content_bci_2 = {
    ...
    gridSubDivCss:
      " mt-12 mx-auto text-white content-center  place-content-center  justify-center  ",
    image: "/images/specific/BCI/3.webp",
  ...
  const content_bci_3 = {
    id: "Banner2",
    bgImage: pageData?.bannerImg2 ? `${process.env.NEXT_PUBLIC_BASE_URL}/${pageData?.bannerImg2}` : "",
    smallBGImage: "",
    logo: "",
    pageTitle: "",
    ...
    bgImgCss:
      "object-fit lg:-mt-28 py-32 xl:py-52 2xl:py-48 bg-cover bg-no-repeat relative  h-screen w-full  lg:bg-[image:var(--largeImage-url)]  bg-[image:var(--smallImage-url)] lazyload bg-[length:200%_100%] md:bg-[length:100%_100%] ",
  ...
  const content_bci_4 = {
    ...
    bgImage: "/images/specific/BCI/6.webp",
    smallBGImage: "/images/specific/BCI/7.webp",
    bgImgCss: "lazyload",
  ...
  const content_Banner3 = {
    id: "Banner3",
    bgImage: pageData?.bannerImg3 ? `${process.env.NEXT_PUBLIC_BASE_URL}/${pageData?.bannerImg3}` : "",
    smallBGImage: "",
    logo: "",
    pageTitle: "",
    pageTitleCss: " text-light  w-full text-center  text-3xl md:text-3xl xl:text-5xl",
  ...
  const content_bci_5 = {
    ...
    gridSubDivCss:
      " mt-12 mx-auto text-white content-center  place-content-center  justify-center  ",
    image: pageData?.rightImg2 ? `${process.env.NEXT_PUBLIC_BASE_URL}/${pageData?.rightImg2}` : "",
  ...
  const content_bci_7 = {
    id: "Banner4",
    bgImage: pageData?.bannerImg4 ? `${process.env.NEXT_PUBLIC_BASE_URL}/${pageData?.bannerImg4}` : "",
    smallBGImage: "",
    logo: "",
    pageTitle: "",
    pageTitleCss: " text-light  w-full text-center  text-3xl md:text-3xl xl:text-5xl",
    ...
    classForblockContent:
      "px-5 md:px-1 lg:w-3/4 xl:w-4/5 2xl:w-2/3 xxl:!w-2/4 mx-auto text-center font-normal text-darkGray mb-10 text-lg md:text-2xl text-white mt-6",
    bgImgCss:
      "object-fit h-screen lg:-mt-28 py-32 xl:py-52 2xl:py-48 bg-cover bg-no-repeat relative  w-full  lg:bg-[image:var(--largeImage-url)]  bg-[image:var(--smallImage-url)] lazyload bg-[length:200%_100%] md:bg-[length:100%_100%] ",
    logoCss: " justify-left align-left  mb-5 lazyload",
    paraCss: "subTitle text-justify font-normal",
    gridCss:
      "grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2  md:mx-20 lg:mx-10 xl:mx-20 place-content-center  lg:h-full   xl:h-full h-full content-center  ",
  ...
  const content_bci_9 = {
    bgImage: "/images/specific/BCI/9.webp",
    smallBGImage: "",
    bgImgCss:
