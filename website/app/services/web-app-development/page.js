...
const WebAppDevelopment = ({ data }) => {
    const content_leftContentBgImg = {
        ...
        gridCss: "grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2   md:grid-cols-2  py-10  md:py-20 xl:py-0 2xl:py-20 h-auto md:h-full lg:h-full   xl:h-full 2xl:h-full xl:-mt-16 2xl:mt-auto",
    ...
    const content_developerBlk = {
        id: "developerBlk",
        paraTitle:
            "<span class='text-light font-bold uppercase leading-relaxed'> Let’s Elevate Your Business<br/> <span class='title text-orange-400 text-left uppercase leading-relaxed' > Request a Quote for a custom solution tailored to your needs. </span>",
    ...
    const content_SmallBanner2 = {
        ...
        paraCss:
            "BlockTitle uppercase text-light text-center md:text-center px-10 md:px-20 leading-tight",
    };
    ...
    const content_WhyChoose = {
        ...
        bgImageCss: "w-2/3 lg:w-full h-auto object-cover mx-auto mt-7",
  ...
  const content_contactUs = {
    ...
    const content_ProblemAns1 = {
        ...
        blockTitle: " <span class='font-extrabold'>THE TOP CHALLENGES IN <br/></span> <span class='font-normal leading-relaxed '> CRAFTING A POWERFUL MOBILE APP </span>",
        classForblockTitle: "w-full text-center  text-2xl md:text-3xl xl:text-5xl px-3 md:px-0 ",
        ...
        content1Css: "col-span-3  h-auto p-5 md:px-12 md:py-24 inline-block align-middle item-center  py-auto  px-10 block border shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-3xl",
        title1: "PROBLEM",
        title1Css: "text-2xl md:text-3xl xl:text-5xl   font-extrabold text-left leading-relaxed",
        ...
        content2Css: "col-span-3 h-auto p-5 md:px-12 md:py-24  block border shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-3xl",
    ...
    const content_ProblemAns2 = {
        ...
        content1Css:
            "col-span-3 h-auto p-5 md:px-12 md:py-24 block border shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-3xl",
        title1: "PROBLEM",
        title1Css: "text-2xl md:text-3xl xl:text-5xl   font-extrabold text-left leading-relaxed",
        ...
        para1Css: "font-normal text-lg md:text-2xl xl:text-2xl leading-relaxed",
        grid2Css: "grid grid-cols-1 md:grid-cols-4 px-10 2xl:px-24 gap-x-5 mt-20",
        // img2GridCss:"",
