...
const EnhanceUserDigitalExperience = ({ data }) => {
    const content_leftContentBgImg = {
        ...
        h1TxtLine1Css: " font-DrukText text-5xl md:text-5xl xl:text-8xl font-extrabold text-center md:text-left   place-content-left  justify-center content-left mb-5 ",
        h1TxtLine2: "EXPERIENCE",
        h1TxtLine2Css: "outline-title  font-DrukText font-bold text-5xl md:text-5xl xl:text-8xl text-center md:text-left   place-content-left  justify-center content-left mb-5 ",
    ...
    const content_BgImgRightTxt_3 = {
        ...
        paraTitleClass: "text-lg md:text-xl xl:text-xl 2xl:text-xl text-justify font-normal",
        bgImgCss: "lazyload",
    ...
    const content_developerBlk = {
        paraTitle: "<span class='text-light font-bold '>Craft Digital Experiences for enhanced user engagement and business growth.<span class='title text-orange-400 text-left' ><br/> Request a Quote 8459748828 </span>",
    ...
    const content_SmallBanner2 = {
        ...
        paraCss: "BlockTitle text-light leading-relaxed text-center md:text-center font-extrabold "
    }
    ...
    const content_custAquisitions = {
        ...
        paraTitle: "<span class='text-light font-bold'>Embark on a voyage of unrivaled user engagements. and discover more about our robust user Digital Experience services.</span> <br/> <span class='title text-orange-400 text-left' >Contact us today 8459748828 </span>",
        paraTitleClass: "title text-left font-normal leading-tight",
    ...
    const content_custBase = {
        ...
        paraTitle: "<span class='text-light font-bold'>Elevate Your Brand with Unmatched Digital Experiences. </span>  <span class='title text-orange-400 text-left' > Learn how our user experience strategies can bring your digital presence to life. Let’s create user interactions that resonate and retain.</span>",
        paraTitleClass: "title text-left font-normal leading-tight",
