...
const ApplicationModernization = ({ data }) => {
    const content_leftContentBgImg = {
        ...
        gridSubDivCss: " pb-32 md:pb-10 lg:pb-16 2xl:pb-48 my-auto text-white   md:pl-20 lg:pl-20 xl:pl-32 2xl:pl-60",
    ...
    const content_BgImgRightTxt_3 = {
        ...
        paraTitleClass: "subTitle lg:text-xl text-justify font-normal ",
        bgImgCss: "lazyload",
        ...
        gridClass: "grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 place-content-center md:grid-cols-2 md:px-10 xl:px-20 2xl:px-32 xxl:px-48 lg:h-full   xl:h-full h-full content-center md:pt-10 lg:pt-16",
    ...
    const content_SmallBanner2 = {
        ...
        paraCss: "BlockTitle text-light text-center md:text-center font-extrabold leading-relaxed"
    }
