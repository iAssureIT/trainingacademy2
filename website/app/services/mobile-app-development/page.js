...
const MobileAppDevelopment = ({ data }) => {
  ...
  const content_leftContentBgImg = {
    ...
    bgImgCss: "  py-20 h-auto  xl:h-auto md:py-32 xl:py-48 2xl:py-20 lazyload object-fit bg-cover bg-no-repeat relative  lg:bg-[image:var(--largeImage-url)]  bg-[image:var(--smallImage-url)] ",
    ...
    imageCss: 'w-2/3 xl:w-4/5 2xl:w-4/5 mx-auto my-auto object-fit place-content-center object-center 2xl:place-content-left 2xl:object-left lazyloaded',
  ...
  const content_developerBlk = {
    paraTitle: "<span class='text-white font-bold leading-relaxed'> HIRE MOBILE APP DEVELOPERS!<br/> <span class='title text-orange-400 text-left' > START WITH A ONE WEEK TRIAL </span>",
    ...
    modalurlName: "Contact Us",
    modalDisplay: "true",
    modalBtnCss: "w-fit   text-white text-center font-bold text-lg md:text-xl p-2  2xl:px-2  mt-3 border w-1/2 md:w-3/4  lg:w-1/2 xl:w-1/3 2xl:w-1/3 rounded btn hover:bg-offWhite hover:text-black cursor-pointer"
  ...
  const content_SmallBanner2 = {
    ...
    paraCss: "text-xs md:text-2xl xl:text-2xl text-white text-center ",
  ...
  const content_custAquisitions = {
    ...
    paraTitle: "<span class='text-white font-bold leading-relaxed'> GET READY FOR NEW CUSTOMER ACQUISITIONS BY CRAFTING,<br/> <span class='title text-orange-400 text-left' > USER-FRIENDLY, PLATFORM-AGNOSTIC REALITY MOBILE APPS. </span>",
    paraTitleClass: "title text-left font-normal leading-tight",
  ...
  const content_custBase = {
    ...
    bgImgCss: "lazyload ",
    paraTitle: "<span class='text-white font-bold leading-relaxed'> LOOKING TO RETAIN YOUR EXISTING CUSTOMER BASE? BUILD SEAMLESS,<br/> <span class='title text-orange-400 text-left' > SCALABLE AND FUTURE-READY MOBILE APPS </span>",
    paraTitleClass: "title text-left font-normal leading-tight",
  ...
  const content_CaseStudy = {
    ...
    urlName: "/case-study",
    // btnName: "View All",
    btnClass: " text-whiterounded text-sm float-right py-2 px-4 bg-blue-800 ",
    cardsArray: [
  ...
  const content_contactUs = {
    ...
    pageTitleCss: " text-white w-full text-center font-extrabold text-3xl md:text-3xl xl:text-4xl",
    ...
    imgTpTextClass: "text-white w-full text-center font-extrabold text-xl md:text-3xl xl:text-3xl leading-tight",
  ...
  const content_ProblemAns1 = {
    ...
    classForblockTitle: "w-full text-center  text-2xl md:text-3xl xl:text-3xl px-3 md:px-0  ",
    ...
    content1Css: "col-span-3 p-5 md:p-7 block border shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-3xl",
    title1: "PROBLEM",
    ...
    para1Css: "font-[500]  text-lg md:text-xl xl:text-lg ",
    ...
    content2Css: "col-span-3 p-5 md:p-7 block border shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-3xl",
    ...
    paraCss2: "font-normal text-lg md:text-xl xl:text-xl  leading-relaxed",
    listData: [
    ...
    listCss: "font-[500] text-lg md:text-lg xl:text-lg px-5 list-decimal py-2 md:px-7"
  ...
  const content_ProblemAns2 = {
    ...
    para1Css: "font-normal text-lg md:text-xl xl:text-lg  leading-relaxed ",
    grid2Css: "grid grid-cols-1 md:grid-cols-4 px-10 2xl:px-24 gap-x-5 mt-20 md:mt-8 mb-5 md:mb-20",
    // img2GridCss:"",
  ...
  return (
    <div>
      {/* PB added metaData */}
      {isModalOpen && <LandingPageModal modalId="mobileAppFormModal" />}
      <CustomHead
