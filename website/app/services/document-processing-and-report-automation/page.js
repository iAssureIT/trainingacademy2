...
const DocumentProcessing = ({ data }) => {
    ...
    const content_developerBlk = {
        paraTitle: "<span class='text-light font-bold uppercase'> Harness the power of Automated Documentation and Reporting for <br/> <span class='title text-orange-400 text-left uppercase' > enhanced operational efficiency and insightful decision-making. </span> </span>",
