...
const EcommOnline = ({ data }) => {
    ...
    const content_developerBlk = {
        paraTitle: "<span class='text-white font-bold '>Revamp Your Online Store with AI-Driven Personalization.<span class='title text-orange-400 text-left' ><br/> Talk to us now </span>",
    ...
    const content_custBase = {
        ...
        paraTitle: "<span class='text-white font-bold'>Optimize Your Online Store for Success with  <span class='title text-orange-400 text-left' > Personalized Recommendations</span>",
        paraTitleClass: "title text-left font-normal leading-tight",
    ...
    const content_WhyChoose = {
        ...
        repeatedBlkCss: " shadow-none flex items-start h-auto my-10 xl:my-4 ",
    ...
    const content_contactUs = {
        ...
        gridColCss: "my-auto w-full sm:w-2/3 md:w-3/5 rounded-4 lg:w-4/5 xxl:!w-3/5  mx-auto lg:mx-0 text-darkGray content-center  place-content-center  justify-center  px-5  2xl:px-2 md:pl-6 md:pl-16 lg:px-2 xl:pl-20 2xl:pl-40 xxl:pl-40 md:-mt-5",
