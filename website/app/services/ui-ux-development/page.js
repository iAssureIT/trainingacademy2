...
const UIUXDevelopment = ({ data }) => {
  ...
  const content_developerBlk = {
    paraTitle:
      "<span class='text-light font-bold '> Let's Ascend Beyond the Usual. Inquire Today for a design solution uniquely tailored to enchant your customers.<span class='title text-orange-400 text-left' ><br/> Talk to Us! 8459748828 </span>",
  ...
  const content_SmallBanner2 = {
    ...
    titleClass:
      " uppercase text-center mx-auto md:float-right my-auto font-normal BlockTitle leading-loose",
  ...
  const content_custAquisitions = {
    ...
    paraTitle:
      "<span class='text-light font-bold'>User Testing Matters: Get a UX Audit Done <br/> <span class='title text-orange-400 text-left' >Schedule an UX Audit Now 8459748828</span>",
    paraTitleClass: "title text-left font-normal leading-tight",
    gridColCss:
  ...
  const content_custBase = {
    ...
    bgImgCss: "lazyload",
    paraTitle:
      "<span class='text-light font-bold'>Craving a digital presence that resonates? With bespoke UI/UX designs tailored for the future, ensure your users are not merely satisfied, but enchanted. <br/> <span class='title text-orange-400 text-left' > Explore More </span>",
    paraTitleClass: "title text-left font-normal leading-tight",
    gridColCss:
  ...
  const content_WhyChoose = {
    ...
    repeatedBlkCss: " shadow-none flex items-start sm:h-36 md:h-auto my-10 xl:my-5 ",
    imgCss:
  ...
  const content_profitMargin = {
    ...
    bgImgCss: "lazyload",
    paraTitle:
      "Ensure Seamless UX Across Devices . Reach out today to metamorphose your digital interaction.<br/> <span class='title text-orange-400 text-left'> Learn How</span>",
