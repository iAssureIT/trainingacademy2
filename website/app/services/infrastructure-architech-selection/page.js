...
const InfrastructureArchitechSelection = ({ data }) => {
  ...
  const content_developerBlk = {
    paraTitle: "<span class='text-light font-bold uppercase'> Leverage Advanced Infrastructure Solutions for a <br/> <span class='title text-orange-400 text-left uppercase' > Technologically Empowered Business Ecosystem. </span> </span>",
  ...
  const content_custAquisitions = {
    ...
    paraTitle: "<span class='text-light font-bold uppercase'> Let’s Shape a Future-Ready ,<br/> <span class='title text-orange-400 text-left uppercase' >Infrastructure Together!</span> </span>",
    paraTitleClass: "title text-left font-normal leading-tight",
  ...
  const content_CenterContentRepeatableBlocks = {
    ...
    classForCards: " border shadow-[0_3px_10px_rgb(0,0,0,0.2)] text-white p-3 md:p-10 mb-7 rounded-xl",
    classForCardTitle: "text-center  text-darkGray text-xl md:title  font-semibold p-3 pt-20",
