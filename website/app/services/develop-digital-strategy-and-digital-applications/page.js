...
const DevelopDigitalStrategyDigitalApplications = ({ data }) => {
    const content_leftContentBgImg = {
        ...
        h1TxtLine2: "DIGITAL APPLICATIONS",
        ...
        para: "iAssureIT Pioneering Digital Strategy and Application Excellence",
        ...
        image: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-1.webp",
    ...
    const content_BgImgRightTxt_3 = {
        paraTitle: "At iAssureIT, we orchestrate robust digital strategies and craft state-of-the-art digital applications that propel your brand toward a future replete with success and technological finesse. <p>Our journey commences with a deep dive into your digital ecosystem, weaving a tailored strategy that syncs with your brand ethos and orchestrates an application ecosystem that's poised for growth. </p><ul class='list-disc list-inside'><li> Innovative digital strategy, anchored on business intelligence, customer insights, and a future-forward approach.</li><li>Digital application development steered by a blend of creative genius, technical prowess, and an unwavering commitment to your digital elevation.</li><li>A coalition of 150+ digital strategists and application maestros</li> <li>Over 100 successful digital strategy and application projects </li></ul>",
        paraTitleClass: "text-lg md:text-lg xl:text-xl 2xl:text-xl text-justify font-normal",
        bgImgCss: "lazyload",
        pageTitle: "<span class='font-normal uppercase'>Accelerating Digital Evolution </span> <br/><span class='font-extrabold uppercase'>Shaping Success Pathways</span>",
        ...
        image: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-2.webp",
    ...
    const content_developerBlk = {
        paraTitle: "<span class='text-light font-bold '> Discover how our digital application architecture ensures scalability, security, and user-friendliness. <br/> <span class='title text-orange-400 text-left' > Explore iAssureIT Solutions Now </span>",
        ...
        image: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-6.webp",
    ...
    const content_SmallBanner2 = {
        ...
        title: " Discover how our digital application architecture ensures scalability, security, and user-friendliness.",
        ...
        para: " Explore iAssureIT Solutions Now",
        paraCss: "BlockTitle text-light text-center md:text-center font-extrabold md:col-span-2 2xl:col-span-2 leading-loose"
    }
    ...
    const content_custAquisitions = {
        ...
        paraTitle: "<span class='text-light font-bold'>  Propel Digital Excellence; foster brand authority and business growth.  <br/> <span class='title text-orange-400 text-left' > Request a Quote  </span>",
        paraTitleClass: "title text-left font-normal leading-tight",
        ...
        gridClass: "grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 place-content-center md:grid-cols-2  lg:h-full   xl:h-full h-full content-center ",
        bannerClass: "object-fit py-20 bg-cover bg-no-repeat relative  w-full  lg:bg-[image:var(--largeImage-url)]  bg-[image:var(--smallImage-url)] ",
        image: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-9.webp",
        imageCss: "mx-auto sm:object-fit my-auto content-center  place-content-center lazyload",
        imgTagcss: "mx-auto lazyload xl:pt-28",
    }
    const content_CenterContentRepeatableBlocks = {
        id: "Services",
        blockTitle: " <span class='font-extrabold uppercase'>Our Digital Strategy and Application Development Services</span>",
        ...
        cardsArray: [
            {
                ...
                cardTitle: 'Digital Audit and Analysis ',
                classForContent: "justify-content h-auto text-center text-lightGray my-auto text-lg md:text-2xl xl:text-xl 2xl:text-2xl",
                content: "A comprehensive audit to decipher your digital standing and unveil opportunities for growth.",
            },
            {
                id: "service2",
                cardImage: '/images/specific/Services/ServicesIcons/iAssureIT-icon-2.webp',
                altImage: 'imageDescription',
                cardTitle: 'Goal-Oriented Planning ',
                classForContent: "justify-content h-auto text-center text-lightGray my-auto text-lg md:text-2xl xl:text-xl 2xl:text-2xl",
                content: "Tailored digital strategy formulation aligned with your business objectives and market dynamics.",
            }, {
                id: "service3",
                cardImage: '/images/specific/Services/ServicesIcons/iAssureIT-icon-3.webp',
                altImage: 'imageDescription',
                cardTitle: 'Content Marketing Strategy ',
                classForContent: "justify-content h-auto text-center text-lightGray my-auto text-lg md:text-2xl xl:text-xl 2xl:text-2xl",
                content: "Engaging content strategies to foster brand authority and digital visibility.",
            }, {
                id: "service4",
                cardImage: '/images/specific/Services/ServicesIcons/iAssureIT-icon-4.webp',
                altImage: 'imageDescription',
                cardTitle: 'Multi-Channel Approach ',
                classForContent: "justify-content h-auto text-center text-lightGray my-auto text-lg md:text-2xl xl:text-xl 2xl:text-2xl",
                content: "Diversified digital strategies spanning across various platforms for maximized reach and engagement.",
            }, {
                id: "service5",
                ...
                classForContent: "justify-content h-auto text-center text-lightGray my-auto text-lg md:text-2xl xl:text-xl 2xl:text-2xl",
                content: "Continual optimizations to enhance conversion rates and elevate ROI.",
            }, {
                id: "service6",
                ...
                classForContent: "justify-content h-auto text-center text-lightGray my-auto text-lg md:text-2xl xl:text-xl 2xl:text-2xl",
                content: "Leverage actionable insights for informed decision-making and strategy refinement.",
            }, {
                id: "service7",
                cardImage: '/images/specific/Services/ServicesIcons/iAssureIT-icon-7.webp',
                altImage: 'imageDescription',
                cardTitle: 'Ongoing Support and Monitoring ',
                classForContent: "justify-content h-auto text-center text-lightGray my-auto text-lg md:text-2xl xl:text-xl 2xl:text-2xl",
                content: "A long-term partnership with continuous monitoring and strategic optimizations to ensure sustained digital growth.",
            }
        ],
    ...
    const content_custBase = {
        ...
        paraTitle: "<span class='text-light font-bold'> Embark on a journey of digital transcendence with iAssureIT.</span> <br/> <span class='title text-orange-400 text-left' > Let’s weave the digital future, together! </span>",
        paraTitleClass: "title text-left font-normal leading-tight",
    ...
    const content_WhyChoose = {
        ...
        pageTitle: "<span class=' font-normal'>WHY CHOOSE IASSUREIT FOR</span> <br/> <span class='font-extrabold uppercase'>Your Digital Strategy and Application Development Needs?</span> ",
        pageTitleCss: "w-full text-center   BlockTitle leading-tight ",
        bgImage: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-11.webp",
        ...
        repeatedBlocks: [
            {
                ...
                description: "Our seasoned team, with its deep-rooted understanding of the digital realm, is committed to propelling your digital success forward.",
            },
            {
                imageSrc: "/images/specific/Services/WHY_CHOOSE_iAssureIT/2.webp",
                title: "Uncompromised Quality",
                description: "Through rigorous validations, we ensure peak performance and user satisfaction, striving for excellence at every juncture.",
            },
            {
                imageSrc: "/images/specific/Services/WHY_CHOOSE_iAssureIT/2.webp",
                title: "Tailored Solutions",
                description: "Craft bespoke digital strategies and applications that are meticulously aligned with your distinct business landscape, ensuring a perfect fit.",
            },
            {
                imageSrc: "/images/specific/Services/WHY_CHOOSE_iAssureIT/2.webp",
                title: "Enduring Support",
                description: "Our partnership transcends project completion, offering continual support to ensure your digital ecosystem consistently stays ahead of the curve.",
            },
    ...
    const content_profitMargin = {
        ...
        paraTitle: "Leap into the digital epoch with unrivaled strategy and application solutions. Uncover more about our Digital Strategy and Application Development services. <span class='title text-orange-400 text-left'> Schedule a consultation : 8459748828 </span>",
        ...
        image: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-10.webp",
        imageCss: "mx-auto sm:object-fit my-auto content-center  place-content-center lazyload",
        imgTagcss: "mx-auto lazyload",
    }
    const content_accordion = {
        ...
        accordionData: [
            ...
            {
                title: 'Why is a Digital Strategy essential for my business?',
                content: "A Digital Strategy is indispensable as it lays the blueprint for how your business operates and thrives in the digital realm. It provides a structured approach towards achieving your business goals by leveraging digital tools and channels effectively. It not only boosts your online presence but also optimizes your resources, ensuring a higher ROI and a competitive edge in the market."
            },
            {
                title: 'What does \'Develop Digital Strategy\' service entail?',
                content: "Our 'Develop Digital Strategy' service encompasses a thorough analysis of your existing digital operations, identification of your target audience, formulation of goal-oriented plans, and devising a multi-channel approach. It's a comprehensive service aimed at amplifying your digital presence, improving your engagement with the audience, and boosting your business outcomes."
            },
            {
                title: 'How does [Your Company Name] approach Digital Audit and Analysis?',
                content: "We commence by conducting a meticulous audit of your current digital presence, including your website, social media profiles, SEO rankings, and other online activities. This analysis aids in identifying the strengths, weaknesses, and untapped opportunities which serve as a foundation for formulating a robust digital strategy tailored to your business objectives."
            },
            {
                title: 'What is the importance of Content Marketing Strategy in digital growth?',
                content: "Content Marketing Strategy is crucial as it engages your audience, establishes your brand authority, and drives organic traffic. By devising a compelling content plan, we ensure your message resonates with your target audience, which in turn enhances your brand's visibility and credibility in the digital space."
            },
            {
                title: 'How do you ensure the effectiveness of a Multi-Channel Approach?',
                content: "A Multi-Channel Approach is essential for reaching a broader audience and ensuring a stronger online presence. We craft a diversified strategy that leverages various platforms like social media, email marketing, SEO, PPC, etc., to maximize your brand's visibility and engagement across the digital landscape."
            },
            {
                title: 'How does Conversion Rate Optimization (CRO) contribute to digital success?',
                content: "CRO is a pivotal component in maximizing the ROI of your digital assets. It involves optimizing your website and other online platforms to enhance the user experience, thereby improving the conversion rates. Through CRO, we ensure that your digital campaigns are not only reaching a broad audience but also effectively converting leads into customers."
            },
            {
                title: 'What insights do Data-Driven strategies provide?',
                content: "Data-Driven strategies provide invaluable insights into the performance of your digital campaigns. By tracking and analyzing real-time data, we enable you to make informed decisions, refine your strategies, and continually improve your digital performance, ensuring a better ROI and achieving your business goals."
            },
            {
                title: 'How do you ensure the ongoing effectiveness of digital strategies?',
                content: "Our partnership extends beyond the implementation phase. We offer continuous support and monitoring to ensure your digital strategies remain effective and relevant in the ever-evolving digital landscape. This ongoing support aids in adapting to changing market dynamics, ensuring sustained digital success."
            },
            {
                title: 'What makes [Your Company Name] a reliable choice for developing digital applications? ',
                content: "With a seasoned team of experts, we specialize in developing digital applications tailored to your business needs. Our holistic approach, right from auditing to ongoing support, ensures a seamless transition into digital, empowering your brand to thrive in the digital ecosystem."
            },
            {
                title: 'How can I get started with [Your Company Name]’s Develop Digital Strategy and Digital Applications services?',
                content: "Embark on your digital transformation journey by contacting us today. Discuss your digital aspirations with our expert team, and let's chart a path towards achieving remarkable digital success together. Click on the 'Contact us today' button to get started!"
            },
        ]
    }
    ...
    const content_CenterImgLeftRightRepeatableBlocks = {
        ...
        blockTitle: "Empowering Transformation <br/><span class='font-extrabold'>Shaping Your Digital Future</span>",
        ...
        classForblockContent: "px-10 lg:px-20 xl:pb-14 pb-10 h-auto text-justify my-auto text-md lg:text-lg justify-content",
        imageSrc: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-3.webp",
        ...
        leftBlocks: [
            {
                leftTitle: "Strategic digital solutions that foster innovation and drive business growth. Ensuring that every digital initiative is aligned with your core business goals.",
                img: "/images/specific/Services/MobileApp/Icons/1.webp"
            },
            {
                leftTitle: "Our team of strategists uses a data-driven, user-centric approach to craft tailored digital strategies.",
        ...
        rightBlocks: [
            {
                leftTitle: "Equipped with 150+ digital strategy experts committed to transforming your business landscape.",
                img: "/images/specific/Services/MobileApp/Icons/3.webp"
            },
            {
                leftTitle: "Celebrating a track record of 200+ successful digital strategy engagements.",
    ...
    const content_ProblemAns1 = {
        blockTitle: " <span class='font-extrabold uppercase'>The Digital Quandaries Businesses Encounter  <br/></span> <span class='font-normal uppercase'> iAssureIT Digital Solutions </span>",
        ...
        img1GridCss: " m-auto",
        img1: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-4.webp",
        ...
        subTitle1: "Seamless Omni-Channel Experience:",
        subTitle1Css: "font-bold subTitle my-3",
        para1: "Crafting a seamless digital journey across diverse channels.",
        para1Css: "font-normal bodyTxt",
        grid2Css: "grid grid-cols-1 md:grid-cols-4 px-10 2xl:px-24 gap-x-5 mt-20",
        // img2GridCss:"",
        img2: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-5.webp",
        ...
        para2: "iAssureIT Solution: Our Omni-Channel Strategy ensures a coherent and engaging user experience across all digital touchpoints, fostering brand consistency and customer loyalty.",
        paraCss2: "",
    }
    const content_ProblemAns2 = {
        grid1Css: "grid grid-cols-1 md:grid-cols-4 px-10 2xl:px-24 gap-x-5 mt-20",
        img1GridCss: "m-auto",
        img1: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-7.webp",
        content1Css: "col-span-3 p-5 md:p-10 block border shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-3xl",
        title1: "PROBLEM",
        title1Css: "BlockTitle font-montserrat  font-extrabold text-left",
        subTitle1: "Robust Digital Application Architecture:",
        subTitle1Css: "font-bold subTitle my-3",
        para1: "Developing scalable, secure, and intuitive digital applications.",
        para1Css: "font-normal bodyTxt",
        grid2Css: "grid grid-cols-1 md:grid-cols-4 px-10 2xl:px-24 gap-x-5 mt-20 mb-20",
        // img2GridCss:"",
        img2: "/images/specific/Services/Digital-Strategy/iAssureIT-digital-strategy-8.webp",
        content2Css: "col-span-3 p-5 md:p-10 block border shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-3xl",
        title2: "iAssureIT Solution ",
        // subTitle2:"Designing Beyond Aesthetics with iAssureiT",
        para2: "We architect digital applications that are a blend of innovation, user-centricity, and robust backend structures, promoting seamless interactions and business continuity.",
        paraCss2: "",
    }
    return (
        <div>
...
//PB added metaData
DevelopDigitalStrategyDigitalApplications.getInitialProps = async () => {
    // Perform data fetching here (e.g., making API requests)
    var url = '/services/develop-digital-strategy-and-digital-applications'
...
export default DevelopDigitalStrategyDigitalApplications;