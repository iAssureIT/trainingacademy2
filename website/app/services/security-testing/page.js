...
const SecurityTesting = ({ data }) => {
    ...
    const content_developerBlk = {
        paraTitle: "<span class='text-light font-bold uppercase'> Fortify your Digital Assets and instill trust among stakeholders. <br/> <span class='title text-orange-400 text-left uppercase' > Request a Quote 8459748828 </span> </span>",
    ...
    const content_custAquisitions = {
        ...
        paraTitle: "<span class='text-light font-bold uppercase'>  Let iAssureIT be your bulwark against cyber threats.<br/> <span class='title text-orange-400 text-left uppercase' >Let's Safeguard Digital Assets Together! </span> </span>",
        paraTitleClass: "title text-left font-normal leading-tight",
