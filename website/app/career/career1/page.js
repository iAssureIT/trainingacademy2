...
import VideoCarousel from '@/templates/Carousel/AllTypeCarousel/Carousel';

export default function Career1(props) {
        ...
        cardsArray: [
            {
                ...
                classForContent:
                    "justify-content h-auto text-left my-auto text-md lg:text-lg font-[500] ",
                content:
    ...
    const content_passionCareerBlk = {
        id: "developerBlk",
        paraTitle:
            "<span class='text-light font-bold '> Join us at iAssureIT, and be a part of a progressive ecosystem where your contributions are valued, your growth envisioned, and your inovative spirit celebrated.</span>",
        paraTitleClass: "title text-left font-normal text-xl md:text-xl lg:text-2xl xl:text-2xl 2xl:text-3xl xxl:!text-4xl leading-tight md:pl-10",
    ...
    const content_GrowBlk = {
        ...
        paraCss:
            "text-lg sm:text-lg md:text-xl lg:text-xl text-justify font-semibold",
        gridCss:
            "grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:h-full xl:h-full h-full content-center px-5 md:px-10 lg:px-20 xl:px-32 2xl:px-40 xxl:!px-48 gap-20",
        gridSubDivCss:
    ...
    const content_Gallery = {
        ...
        textCss: "absolute bottom-10 text-center mx-auto w-full text-white font-bold text-lgmd:text-2xl",
        gallery_data: [
    ...
    return (
        <div>
            ...
            <VideoCarousel inputData={content_carousel2} showVideos={true} showImages={false} />
