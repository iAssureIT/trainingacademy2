...
const ImageCarousel = (props) => {
   ...
   return (
      <section className={props.inputData.className ? props.inputData.className :"relative mx-auto px-4 md:px-10 lg:px-20 xl:px-20 py-24"}>
         <div className={props.inputData.imgWrap ? props.inputData.imgWrap :"relative flex items-center justify-center overflow-hidden p-20"}>
            {
            ...
            }
            {
               ...
               ?
                  <img 
                     ...
                     className={props?.inputData?.imageCss? props?.inputData?.imageCss:"h-full w-full object-fit-cover"}/>
               :
                  <div>
