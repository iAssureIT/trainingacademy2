          ...
          <div className="w-full mb-5 lg:px-20">
            {selectedVideo
              ...
              <div className="w-full rounded-2xl">
                <video id="selectedVideo" key={selectedVideo} className="w-full rounded-2xl" autoPlay loop muted>
                  <source src={selectedVideo} type="video/mp4" />
                </video>
              </div>
              :
              <div className="w-full rounded-2xl">
                <video id="selectedVideo" key={props.inputData?.videos[0]} className="w-full rounded-2xl" autoPlay loop muted>
