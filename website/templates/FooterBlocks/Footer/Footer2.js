      ...
      >
        <div className="mx-auto w-full max-w-screen-exLG  ">
         <div className="sm:flex sm:items-center sm:justify-between bg-Blue py-3 xl:px-20 px-8">
            ...
            <span className="px-10 text-xs md:text-sm xxl:text-sm  sm:text-center  text-white  hover:text-ftLink"><a href={props.inputData.PrivacyPageURL}>Privacy Policy</a></span>
