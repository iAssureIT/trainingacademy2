      ...
      <section className={props?.inputData?.sectionCss}>
         ...
         }
         {
            props?.inputData?.blockSubTitle
               ?
               <h3 className={props?.inputData?.classForblockSubTitle ? props?.inputData?.classForblockSubTitle : 'blockSubTitle '}
                  ...
                  return (
                     <div className={props.inputData?.classForCards} key={index}>
                        <div className="block">
                           ...
                           <div className={'grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 px-3 md:px-5 py-2 md:py-10 mx-auto'}>
                              {card.imageArr.map((img, index) => {
                                 return (
                                    <img key={index} className="mx-auto lazyload" alt={ "technology "+index}   src={img}  />
                                 )
                              })
                              }</div>
                        </div>
