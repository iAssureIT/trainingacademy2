            ...
            >
                ...
                <div className={props?.inputData?.gridCss ? props?.inputData?.gridCss : " grid grid-cols-1  sm:grid-cols-2  md:grid-cols-2   lg:grid-cols-2 2xl:grid-cols-2  xl:grid-cols-2 h-full w-full content-center "}>
                    ...
                    }
                    {
                        ...
                        ? 
                        <div className={props?.inputData?.videoDivCss?props?.inputData?.videoDivCss:"group relative"}>
                            <div className='px-3 lg:px-12  ' style={{}}>
                                <video id={"vid"} className={props?.inputData?.videoClass? props?.inputData?.videoClass:" xl:mt-10 2xl:mt-0 rounded-xl "} loop autoPlay height="1000" controls muted controlsList="nodownload" >
