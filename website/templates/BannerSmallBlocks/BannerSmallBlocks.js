            ...
            <div className="mx-1 md:mx-20 lg:mx-16 xl:mx-24 lg:-mt-24 h-auto">
                <div className="grid p-5 block bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-2xl grid-cols-1 lg:grid-cols-4 lg:gap-4">
                    {props.inputData?.blockTitles.map((title, index) => (
                        <div key={index} className="bg-cover min-h-24 md:h-auto px-2 my-5 lg:my-0 py-4 block bg-no-repeat max-w-full sm:bg-cover bg-center lazyload lg:bg-[image:var(--largeImage-url)] bg-[image:var(--smallImage-url)] hover:shadow-[0_3px_10px_rgb(0,0,0,0.2)] cursor-pointer hover:text-white hover:font-bold hover:text-lg"
                            style={{
