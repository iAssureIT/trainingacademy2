			...
			<div id={"Menubar"} ref={menuRef} className=" fixed z-10 w-full ">
				<nav className="navBar1 bg-transparent border-gray-200 dark:bg-gray-900 dark:border-gray-700 ">
					<div className={props?.inputData?.navCss ? props?.inputData?.navCss : "max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4"}>
						...
						<button id="navbar-toggle" data-collapse-toggle="navbar-dropdown"  className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-200 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-dropdown" aria-expanded="false">
											...
											return (
												...
												data?.showSubMenu ?
													<li key={index} >
														...
														<div id="dropdownNavbar" className="absolute z-10 md:left-0 w-auto xs:w-44 sm:w-72 md:w-full lg:w-full hidden font-normal md:mt-7 bg-white divide-y text-lg divide-gray-100 md:rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] dark:bg-gray-700 dark:divide-gray-600">
																...
																{data?.subMenu?.map((val, index) => {
																	return (
																		...
																		<li key={index} className="w-full sm:w-72 md:w-full lg:w-32 cursor-pointer" >
																			...
																			<div id={"doubleDropdown" + val.id} className="z-10 absolute hidden md:top-5 -left-44 sm:left-1 md:left-10 lg:left-40 2xl:left-72 w-full px-2 sm:w-[30rem] md:w-[34rem] lg:w-[45rem] xl:w-3/4 xxl:w-4/5 bg-white divide-y divide-gray-100 rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] dark:bg-gray-700 transform translate-x-44 dd ">
