...
function MenuBar(props) {
   ...
   return (
      <div className="">
         ...
         <nav 
            className={pathname!=="/" ?"bg-cover  bg-no-repeat sm:bg-cover  bg-[image:var(--largeImage-url)]  bg-right  flex justify-between flex-wrap px-6 md:px-20 py-3 lg:h-20 xl:h-20 h-20 ":" flex justify-between flex-wrap px-6 md:px-20 lg:py-3 lg:h-20 xl:h-20 h-10 bg-[image:var(--largeImage-url)] lg:bg-none"}
            style={{
               '--largeImage-url': `url(${imageURL})`,
               backgroundSize: "100% 100%"
            }}    
         >
            <div className="hidden md:hidden lg:block items-center h-14 flex-shrink-0 text-white mr-6 object-fit">
               <a href="/">
               <img
                     ...
                     (
                        <div className=" lg:block flex flex-wrap items-center md:order-2 px-8">
                           ...
                           >
                              ...
                              <div className="w-60 p-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg  dark:bg-gray-700 dark:divide-gray-600">
            ...
            <div className="block  lg:hidden">
               <button
                  ...
                  className="flex items-center px-3 mt-3 lg:mt-6 pl-6 rounded text-white hover:text-white"
               >
                  <svg
            ...
            <div className={`w-full block h-8 py-4 xl:py-7 2xl:py-10 flex-wrap lg:flex lg:items-right float-right
            ...
            >
               ...
               <div className="text-sm lg:flex lg:flex-wrap h-8 ">
                  {userData ? (
                     ...
                     <ul
                        id="navBar"
                        className=" text-xs xxl:text-lg font-semibold flex flex-col p-4 md:p-0 mt-4  float-right  rounded-lg  md:flex-row md:space-x-8 md:mt-0 text-black lg:text-white bg-white lg:bg-transparent shadow-xl lg:shadow-none"
                     >
