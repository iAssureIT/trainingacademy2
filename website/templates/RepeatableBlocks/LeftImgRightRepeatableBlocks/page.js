...
const LeftImgRightRepeatableBlocks = (props) => {
  return (
      ...
      <div className={` ${props.inputData?.classForblockContainer}`}>
        <div className={` ${props.inputData?.classForImageContainer}`}>
          <div className={` ${props.inputData?.classForCardImage}`}>
            ...
            <Image
              src={props.inputData?.imageSrc}
              alt={props.inputData?.imageAlt}
              // layout="fill"
              objectFit="cover"
            />
          </div>
        </div>
        <div className={` ${props.inputData?.classForRightContainer}`}>
          {/* Repeated Blocks */}
          <div className={` ${props.inputData?.classForRightContainer1}`}>
            <div
              className={` ${props.inputData?.classForRightinsideContainer}`}
            >
              <div
                className={` ${props.inputData?.classForRightimageContainer}`}
              >
                <div style={{ paddingTop: "50%", position: "relative" }}>
                  <img
                    src="your-image-url.jpg"
              ...
              <div
                className={` ${props.inputData?.classForRightimageTextContainer}`}
              >
                <h2
                  className={` ${props.inputData?.classForRightimageTitleContainer}`}
                >
                  {props?.inputData?.imgTitle}
                </h2>
                <h3
                  className={` ${props.inputData?.classForRightimageTitleContainer}`}
                >
                  {props?.inputData?.imgTitleText}
                </h3>
              </div>
            </div>
          </div>
...
module.exports = LeftImgRightRepeatableBlocks;
